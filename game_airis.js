...
//name,    img, _hp, at, def,hit agi skill
  ...
  ['★2 スリ男子', 11, 110, 25, 20, 20, 20, ['スリ'], 'スラムの女の子。\nいつもお腹を空かせている。\nスリの常習犯。\n悪いことはしちゃダメ。'],
  ['★3 スリ男', 12, 150, 30, 25, 25, 25, ['スリ'], 'スラムの男。\nいつもお腹を空かせている。\nスリの常習犯。\n悪いことはしちゃダメ。\n子供にスリを教えている。'],
  [],[],[],[],[],[],[],[],
  [],[],[],[],[],[],[],[],[],[],
  [],[],[],[],[],[],[],[],[],[],
  [],[],[],[],[],[],[],[],[],
  ['★0 雑草',   50,  80, 40, 20, 10, 10, [], 'どこにでも生えてくる雑草だ。\n雑草だけにすぐ伸びる。\n草刈りをしよう。'],
  ['★1 薬草',   51, 100, 30, 15, 10, 10, [], 'ポーションの材料になる薬草だ。\n薬草も強くすぐ伸びる。\n草刈りをしよう。'],
  [],[],[],[],[],[],[],[],
  ['★5 オーガ', 60, 250, 30, 40, 40, 10, ['咆哮'], '中級モンスター大鬼だ。\n防御力やHPが高くなかなか手ごわい。'],
  ['★3 ウルフ', 61, 150, 50, 10, 30, 10, ['咆哮'], '魔獣の一種、狼だ。\n攻撃力が高くなかなか手ごわい。'],
  ['★2 ディア', 62, 100, 20, 10, 10, 40, ['回避'], '魔獣の一種、鹿だ。\n回避能力が高くなかなか手ごわい。'],
  ['★4 ベア',   63, 200, 40, 30, 30, 10, ['回避'], '魔獣の一種、熊だ。\n巨体による強力な攻撃力だ。'],
...
const battle_map_cards = [
  ...
  ['2-1.サーナ捜索(1)', ['黒猫', 4], ['白猫', 5], ['トラ猫', 6], ['雑草', 50]],
  ['2-2.サーナ捜索(2)', ['茶犬', 7], ['白犬', 8], ['黒猫', 4], ['白猫', 5]],
  ['2-3.サーナ捜索(3)', ['サーナ', 3], ['黒猫', 4], ['茶犬', 7], ['白犬', 8]],
  ['3-1.裏路地(1)', ['スリ男子', 10], ['黒猫', 4], ['白猫', 5], ['トラ猫', 6]],
  ...
  ['6.ドッペルゲンガー', ['Dマリア', 1], ['Dエルナ', 2], ['Dサーナ', 3], ['ベア', 63]],
];
...
function draw_title(){
  ...
  text(title_text, w -1, h +1);
  text(title_text, w +0, h -1);
  text(title_text, w +0, h +1);
  text(title_text, w +1, h -1);
  text(title_text, w +1, h +0);
  text(title_text, w +1, h +1);
  text(title_text, w +0, h +2);
  text(title_text, w +1, h +2);
  text(title_text, w +2, h +1);
  text(title_text, w +2, h +2);
  text(title_text, w +2, h +1);
  text(title_text, w +2, h +0);
  fill(0);
  text(title_text, w, h);
}
