...
const card_base = [
  ...
  [],
  ['★5 マリア・ファイアランス', 1, 200, 50, 30, 30, 10, ['2回攻撃'], 'スキル：2回攻撃\n剣士の冒険者。\nパーティー「レッドキャッツ」のリー\nダーを務める。', ['2回攻撃、えいやっ！！', '2回攻撃、いっけぇ！！', '2回攻撃、そりゃぁ！']],
  ['★5 エナル・ブルーサファイア', 2, 150, 70, 15, 30, 10, ['ファイアボール'], '魔法使いの冒険者。\nパーティー「レッドキャッツ」のメン\nバー。【青髪の魔女】の二つ名を持つ。', ['ファイア・アロー', 'アイス・ミサイル', 'エア・スラッシュ']],
  ['★5 サーナ・ゴールドラッシュ', 3, 180, 60, 20, 30, 10, ['アロー'], '弓使いの冒険者。\nパーティー「レッドキャッツ」の\nポーター。\n【期待の猫娘】と呼ばれている。', ['弓をくらえにゃ！', '攻撃するにゃ', 'どんどんにゃ']],
  ...
  ['★5 アリス・リッテンマイア', 9, 190, 50, 35, 20, 10, ['2回攻撃'], 'スキル：2回攻撃\n姫騎士【王国の秘宝】。\nエアイズ王国第一王女。\n美しく聡明な姫様。\n冒険者としても活動している。', ['2回攻撃、いきますっ', '2回攻撃、今度こそ！', '2回攻撃、やります！']],
  ...
  ['★4 ミーナ・ロバーツ', 15, 250, 50, 25, 25, 25, ['計算'], '美人受付嬢。\n冒険者ギルドの受付嬢。\n特技は素早い事務処理に素材の目利き。\n冒険者に人気だ。\nしかし彼氏の噂は全然聞かない。\n実は凄腕の冒険者でもあり模擬戦も\nこなす。', ['手加減してますよ', '掛かってきなさいっ', '実力を見せてください']],
  ...
  [],[],[],[],[],[],[],[],
  ['★5 グリーン・オーガ', 60, 250, 30, 40, 40, 10, ['咆哮'], '中級モンスター大鬼だ。\n防御力やHPが高くなかなか手ごわい。', ['ウオオオオオ', 'グォオオ', 'グアアア']],
  ['★3 フォレスト・ウルフ', 61, 150, 50, 10, 30, 10, ['咆哮'], '魔獣の一種、狼だ。\n攻撃力が高くなかなか手ごわい。', ['ワオーン', 'キャンキャン', 'グルルル']],
  ['★2 ホーン・ディア', 62, 100, 20, 10, 10, 40, ['回避'], '魔獣の一種、鹿だ。\n回避能力が高くなかなか手ごわい。', ['キャン', 'キャンキャン', 'キャンッ']],
  ['★4 イビル・ベア', 63, 200, 40, 30, 100, 10, ['必中'], '魔獣の一種、熊だ。\n巨体による強力な攻撃力だ。', ['グワアア', 'ウオオオオ', 'オオオオ']],
  ['★1 ブルー・スライム', 64, 90, 30, 30, 20, 50, ['回避'], '初級モンスターだ。\n小さく回避力が高い。\nあらゆる場所に住んでいる。', ['ピュピュ', 'ミュムム', 'ポムポム']],
  ['★2 グラス・ラビット', 65, 140, 35, 10, 30, 30, ['回避'], '魔獣の一種、兎だ。\n小さいわりに攻撃力もある。\n草原に多く生息している。', ['ピチュ', 'ピッピッ', 'ピィィ']],
  ['★3 ポイズン・スネーク', 66, 210, 45, 10, 35, 20, ['巻きつく'], '魔獣の一種、蛇だ。\nその巨体は圧巻だ。\n森林に多く生息している。', ['ギャア', 'グギャ', 'ギイイ']],
  ['★3 ゴースト', 67, 150, 45, 10, 35, 20, [''], 'アンデッドの一種、幽霊。\nアンデッドの森に生息する。', ['(シューン)', '(ぽわぽわ)', '(シュッシュ)']],
  ['★3 ジャック・オ。ランタン', 68, 160, 45, 20, 35, 20, [''], 'アンデッドの一種、カボチャのお化け。\nその巨体は圧巻だ。\nアンデッドの森に生息する。', ['クワァ', 'カカカ', 'ワッハハ']],
  ...
  ['★5 サンタ・クロース', 71, 250, 45, 30, 40, 20, ['2回攻撃'], 'クリスマスに発生する。\n闇に落ちたサンタ。\nクリスマス箱を持ってくる。', ['ひゃほううう', 'メリー、クリスマス', 'いい子にしていたかな？']],
  ['★4 ジンジャー・ブレッドマン', 72, 210, 45, 20, 35, 20, [''], 'クリスマスに発生する。\n人型のクッキーだ。', ['美味しいよ', '甘いよ', '食べないでぇ']],
...
function draw() {
  ...
  textSize(12);
  textAlign(LEFT);
  text('エアイズ王国：カードバトル v0.08.20231209', 30, 14);
  textAlign(CENTER);
