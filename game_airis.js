...
//name,    img, _hp, at, def,hit agi skill
  ...
  ['★4 ベア',   63, 200, 40, 30, 30, 10, ['咆哮'], '魔獣の一種、熊だ。\n巨体による強力な攻撃力だ。', ['グワアア', 'ウオオオオ', 'オオオオ']],
...
const battle_map_cards = [
  ...
  ['6-3.ドッペルゲンガーの森', ['Dマリア', 1], ['Dエルナ', 2], ['Dサーナ', 3], ['ベア', 63]],
];
const battle_map_chat = [
  ...
  /*'6-3.ドッペルゲンガーの森(終)',*/  '私たちの「ドッペルゲンガー」を\n倒した。\n\nCongratulations!!\nおめでとうございます。\n第一章はこれでおしまいです。\n継続すると第一話に戻ります。',
];
let battele_data = {
...
function draw() {
  ...
  textSize(12);
  textAlign(LEFT);
  text('エアイズ王国：カードバトル v0.05.20231203', 30, 14);
  textAlign(CENTER);
